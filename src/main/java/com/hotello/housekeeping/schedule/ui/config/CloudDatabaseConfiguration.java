...
@Configuration
@EnableMongoRepositories("com.hotello.housekeeping.schedule.ui.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.hotello.housekeeping.schedule.ui.config.dbmigrations");
